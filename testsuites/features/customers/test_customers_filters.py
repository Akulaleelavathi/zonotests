...
def test_customerdatafororders(return_customerdata,setup,workspacedata,return_orders):
    ...
    # print(f"return the response{responsedata.json}")
    ...
    get_add_res=orderObj.editadd_product(return_orders,workspacedata,product_list)
